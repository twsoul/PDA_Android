        ...
        if (uuid == null) {
            synchronized (Device_Uuid_Get.class) {
                if (uuid == null) {
                    ...
                    if (id != null) {
                        //todo   Use the ids previously computed and stored in the
                        // prefs file
                        uuid = UUID.fromString(id);
                    } else {
                        final String androidId = Secure.getString(
                                context.getContentResolver(), Secure.ANDROID_ID);
                        //todo   Use the Android ID unless it's broken, in which case
                        ...
                        //todo   Write the value out to the prefs file
                        prefs.edit()
