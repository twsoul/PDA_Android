...
public class Act_InvInsp extends Act_MainTitleActivity implements CRV_IF_BCR_Info_AdapterListener, ScannerReceiver_Listner {
    //현재 Context
    private Context mContext = Act_InvInsp.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //region  컨트롤 정의 부분 ///////////////////////////////////////////////////////////////////////
        setContentView(R.layout.act_inv_insp);
        //타이틀바 이름 변경.
        setTitle("재고실사");
        //진동시킬 변수를 생성한다.
        ...
        btn_Save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                            ...
                            for (int iRow = 0; iRow < Save_ItemList.size(); iRow++) {
                                ...
                                try {
                                    ...
                                    if (Save_ItemList.get(iRow).isSelected()) {
                                        ...
                                        CustomParameters param = new CustomParameters("SP_ANDROIDPDA_INV_INSP_S");
                                        param.add("@P_BCR_ID", Save_ItemList.get(iRow).getBCR_ID());
                                        param.add("@P_QTY ", Save_ItemList.get(iRow).getQTY());
                                        param.add("@P_CREATE_BY", _Login_Info.getString("loginId", null));
                ...
                }, mContext, "수량변경확인", "재고실사하시겠습니까?", "예", "아니오");
        ...
        Btn_Search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    //todo   json parsing 된 문자를 가져올 URL 설정.
                    CustomParameters param = new CustomParameters("SP_ANDROIDPDA_INV_INSP_L");
    ...
    public void DataBinding(ArrayList<CRV_BCR_Info_ItemObject> arr_Set_Object) {
        ...
        //todo  실제데이터들 넘김
        _CRV_BCR_Info_Adapter = new CRV_BCR_Info_Adapter(mContext, arr_Set_Object, true);
