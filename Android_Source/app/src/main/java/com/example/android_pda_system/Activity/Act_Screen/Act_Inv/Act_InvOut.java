...
public class Act_InvOut extends Act_MainTitleActivity implements CRV_IF_BCR_Info_AdapterListener, ScannerReceiver_Listner {

    //현재 Context
    private Context mContext = Act_InvOut.this;
    ...
    //todo 바코드 인식할때 작동하는 Method ExtensClass에서 리스너 등록되어있음.
    @Override
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //region  컨트롤 정의 부분 ///////////////////////////////////////////////////////////////////////
        setContentView(R.layout.act_inv_out);
        //타이틀바 이름 변경.
        setTitle("재고출고");
        //진동시킬 변수를 생성한다.
        ...
        //todo   저장 버튼 클릭 시 이벤트
        Btn_InvOut.setOnClickListener(new View.OnClickListener() {
            @Override
                            ...
                            for (int iRow = 0; iRow < Save_ItemList.size(); iRow++) {
                                ...
                                try {
                                    ...
                                    if (Save_ItemList.get(iRow).isSelected()) {
                                        ...
                                        CustomParameters param = new CustomParameters("SP_ANDROIDPDA_BCR_TRANS_OUT_S");
        ...
        Btn_Search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    //todo   json parsing 된 문자를 가져올 URL 설정.
                    CustomParameters param = new CustomParameters("SP_ANDROIDPDA_BCR_TRANS_OUT_L");
    ...
    public void onListItemClicked(CRV_BCR_Info_Adapter adapter, int position, String Update_String) {
        //todo adapter에는 현재 아답터 정보를 가져 온다.
        if (_CRV_BCR_Info_Adapter == adapter) {
